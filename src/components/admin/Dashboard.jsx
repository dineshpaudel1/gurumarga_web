...
import { fetchCourses } from "../../Apis/CourseApi"; // Adjust the import path as necessary
import { fetchTotalUserCount } from "../../Apis/UserApi"; // Import user count function
import { fetchEnrolledUserCount } from "../../Apis/EnrollmentApi"; // Import the function to fetch enrolled user count
import { fetchCategories } from "../../Apis/CategoryApi"; // Import category count function
