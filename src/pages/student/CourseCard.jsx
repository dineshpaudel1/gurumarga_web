          ...
          <div className="p-3 flex-grow flex flex-col">
            <div className="flex items-center mb-1">
              <div className="rating-stars flex items-center text-yellow-500">
                ...
                <span className="ml-1 text-sm">{rating || 4.7}</span>
              </div>
              <span className="ml-2 text-xs text-gray-500">({reviewsCount || 1220})</span>
            </div>
            ...
            <div className="flex items-center mt-auto pt-2 border-t border-gray-100">
              <span className="text-xs text-gray-600">{instructor.name || "Dinesh Paudel"}</span>
            </div>
          </div>
